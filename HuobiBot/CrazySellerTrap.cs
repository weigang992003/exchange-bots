...
namespace HuobiBot
{
    ...
    internal class CrazySellerTrap : ITrader
    {
        ...
        public CrazySellerTrap(Logger logger)
        {
            ...
            _logger.AppendMessage(String.Format("Crazy seller trap trader initialized with operative={0}; MinWall={1}; MaxWal={2}", _operativeAmount, _minWallVolume, _maxWallVolume));
